...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#project"
                ...
                <span class="m-0 font-weight-bold text-primary">Tupad Project</span>
                <i class="fa-solid fa-square-caret-down"></i>
            </a>
    ...
    <div class="card shadow mb-4">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#beneficiary"
                aria-expanded="true" aria-controls="tupad">
                {{-- <i class="fa fa-users"></i> --}}
                <i class="fa-solid fa-square-caret-down"></i>
                <span class="m-0 font-weight-bold text-primary">Tupad Beneficiary</span>
                <i class="fa-solid fa-square-caret-down"></i>
        </a>
        {{-- <div class="card-header py-3">
        ...
        <!-- Content Row -->
        <div id="beneficiary" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="row">
